...
namespace MongoDB.Repository
{
    ...
    public class MongoSession
    {
        ...
        public MongoSession(string connString, string dbName, WriteConcern writeConcern = null, MongoSequence sequence = null,ReadPreference readPreference = null)
        {
        ...
        /// <returns></returns>
        public FieldsDocument IncludeFields<T>(Expression<Func<T, object>> fieldsExp = null)
            where T : class, new()
        {
